...
export const Privacy: React.FC = () => {
  ...
  return (
  <>
    <SEOHead title="Privacy Policy" description="Privacy policy for Kingdom Network. Learn how we collect, use, and protect your personal information." />
      ...
      <Container>
        <div className='max-w-3xl mx-auto space-y-12'>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className='heading-2 text-brand-primary dark:text-brand-white mb-4'>1. Information We Collect</h2>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
            <h2 className='heading-2 text-brand-primary dark:text-brand-white mb-4'>2. How We Use Your Information</h2>
            <p className='text-brand-text dark:text-brand-white/90 leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
            <h2 className='heading-2 text-brand-primary dark:text-brand-white mb-4'>3. Information Sharing</h2>
            <p className='text-brand-text dark:text-brand-white/90 leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}>
            <h2 className='heading-2 text-brand-primary dark:text-brand-white mb-4'>4. Data Security</h2>
            <p className='text-brand-text dark:text-brand-white/90 leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }}>
            <h2 className='heading-2 text-brand-primary dark:text-brand-white mb-4'>5. Your Rights</h2>
            <p className='text-brand-text dark:text-brand-white/90 leading-relaxed mb-4'>
            ...
            <p className='text-brand-text dark:text-brand-white/90 leading-relaxed mt-4'>
              To exercise these rights, please contact us at <a href='mailto:privacy@kingdomnetwork.com.np' className='text-brand-primary dark:text-brand-white hover:text-brand-secondary'>privacy@kingdomnetwork.com.np</a>
            </p>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.5 }}>
            <h2 className='heading-2 text-brand-primary dark:text-brand-white mb-4'>6. Cookies</h2>
            <p className='text-brand-text dark:text-brand-white/90 leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.6 }}>
            <h2 className='heading-2 text-brand-primary dark:text-brand-white mb-4'>7. Changes to This Policy</h2>
            <p className='text-brand-text dark:text-brand-white/90 leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.7 }}>
            <h2 className='heading-2 text-brand-primary dark:text-brand-white mb-4'>8. Contact Us</h2>
            <p className='text-brand-text dark:text-brand-white/90 leading-relaxed mb-4'>
            ...
            <address className='not-italic text-brand-text dark:text-brand-white/90 leading-relaxed'>
              <p>Kingdom Network</p>
              <p>{contact.address}</p>
              <p>Email: <a href='mailto:privacy@kingdomnetwork.com.np' className='text-brand-primary dark:text-brand-white hover:text-brand-secondary'>privacy@kingdomnetwork.com.np</a></p>
