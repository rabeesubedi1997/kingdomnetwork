      ...
      <Container>
        <div className='max-w-3xl mx-auto space-y-12'>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className='heading-2 text-brand-primary mb-4'>1. Acceptance of Terms</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
              By accessing and using the Kingdom Network website (<code className='px-1.5 py-0.5 bg-brand-primary/10 text-brand-primary rounded text-sm font-mono'>https://kingdomnetwork.com.np</code>), you accept and agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree, please do not use our website.
            </p>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
            <h2 className='heading-2 text-brand-primary mb-4'>2. Use of Website</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
            <h2 className='heading-2 text-brand-primary mb-4'>3. Intellectual Property</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}>
            <h2 className='heading-2 text-brand-primary mb-4'>4. User Submissions</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }}>
            <h2 className='heading-2 text-brand-primary mb-4'>5. Third-Party Links</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.5 }}>
            <h2 className='heading-2 text-brand-primary mb-4'>6. Disclaimers</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.6 }}>
            <h2 className='heading-2 text-brand-primary mb-4'>7. Limitation of Liability</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.7 }}>
            <h2 className='heading-2 text-brand-primary mb-4'>8. Governing Law</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.8 }}>
            <h2 className='heading-2 text-brand-primary mb-4'>9. Changes to Terms</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.9 }}>
            <h2 className='heading-2 text-brand-primary mb-4'>10. Contact Information</h2>
            <p className='text-brand-text leading-relaxed mb-4'>
            ...
            <address className='not-italic text-brand-text leading-relaxed'>
              <p>Kingdom Network</p>
              <p>Kathmandu, Nepal</p>
              <p>Email: <a href='mailto:legal@kingdomnetwork.com.np' className='text-brand-primary hover:text-brand-secondary'>legal@kingdomnetwork.com.np</a></p>
